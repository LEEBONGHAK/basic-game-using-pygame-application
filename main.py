...
# 화면 타이틀 설정
pygame.display.set_caption("BongHak Pang")  # 게임 이름
...
balls.append({
    ...
    "to_x": 3,  # x 축 이동 방향, -3 이면 왼쪽, 3 이면 오른쪽 이동
    "to_y": -6,  # y 축 이동 방향
...
while running:
    ...
    # 공 위치 정의
    for ball_idx, ball_val in enumerate(balls):  # index와 값을 같이 가져올 수 있다.
            ...
            if weapon_rect.colliderect(ball_rect):
                ...
                if ball_img_idx < 3:
                    ...
                    balls.append({
                        ...
                        "to_x": -3,  # x 축 이동 방향, -3 이면 왼쪽, 3 이면 오른쪽 이동
                        "to_y": -6,  # y 축 이동 방향
                        "init_spd_y": ball_speed_y[ball_img_idx + 1]  # y 속도
                    })
